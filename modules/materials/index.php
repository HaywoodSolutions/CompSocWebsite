                            ...
                            <div class="col-sm-12 col-md-12">
                                <ul class="list-group" id="listFilter">
                                    <li class="list-group-item justify-content-between align-items-center d-flex active">
                                        ...
                                        <h3><?php echo $module_id; ?> Materials</h3>
                                        <a class="btn btn-secondary home" href="/" role="button"></a>
                                    </li>
                                    <?php 
                                        $materials = $db->getCourseMaterials($module_id);
                                        if (sizeof($materials) <= 0){
                                            ?>
                                                <div class="list-group-item">
                                                    <span>There are no materials available for this course at the moment</span>
                                                </div>
                                            <?php
                                        } else {
                                            foreach($materials as $material) {
                                                ?>
                                                    <a class="list-group-item list-group-item-action" target="_blank" href="/getfile?id=<?php echo $material["file_id"]; ?>">
                                                        <span><i class="fas fa-external-link-alt"></i> <?php echo $material["name"]; ?></span>
                                                    </a>
                                                <?php
                                            }
                                        }
