                                ...
                                <div class="col-sm-12 col-md-12">
                                    <ul class="list-group" id="listFilter">
                                        <li class="list-group-item justify-content-between align-items-center d-flex active">
                                            ...
                                            <h3><?php echo $module_id; ?> Module</h3>
                                            <a class="btn btn-secondary home" href="/" role="button"></a>
                                        </li>
                                        <a class="list-group-item list-group-item-action" href="./lecture-view?module_id=<?php echo $module_id; ?>">
                                            <span><i class="fas fa-link"></i> Lectures</span>
                                        </a>
                                        <a class="list-group-item list-group-item-action" href="./materials?module_id=<?php echo $module_id; ?>">
                                            <span><i class="fas fa-link"></i> Materials</span>
                                        </a>
                                        <a class="list-group-item list-group-item-action" href="./support?module_id=<?php echo $module_id; ?>">
                                            <span><i class="fas fa-link"></i> Support</span>
                                        </a>
                                        <a class="list-group-item list-group-item-action" href="./assessments?module_id=<?php echo $module_id; ?>">
                                            <span><i class="fas fa-link"></i> Tasks/Assessments</span>
                                        </a>
                                        <a class="list-group-item list-group-item-action" href="./papers?module_id=<?php echo $module_id; ?>">
