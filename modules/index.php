                                    ...
                                    <ul class="list-group" id="listFilter">
                                        ...
                                        <?php 
                                            ...
                                            foreach($courses as $course) {
                                                ?>
                                                    <a class="list-group-item list-group-item-action" href="./view?module_id=<?php echo $course["id"]; ?>">
                                                        <span><i class="fas fa-link"></i> <?php echo $course["id"]; ?> - <?php echo $course["name"]; ?></span>
                                                    </a>
                                                <?php
                                            }
                                        ?>
